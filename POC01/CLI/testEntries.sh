...
cmd="peer chaincode invoke -l golang -n anz -c '{\"Function\":\"addPaymentInstruction\", \"Args\": [\"1000\",\"ANZ\",\"WF\",\"$date\",\"OUR\",\"$vDate\",\"12345\",\"USD\",\"$localDate\",\"123\",\"103\",\"WF\"]}'"
...
localDate="$(TZ='Australia/Melbourne' date '+%FT%T.%N%:z')";
# echo $vDate
cmd="peer chaincode invoke -l golang -n anz -c '{\"Function\":\"addPaymentInstruction\", \"Args\": [\"2000\",\"ANZ\",\"WF\",\"$date\",\"SHA\",\"$vDate\",\"123456\",\"USD\",\"$localDate\",\"123\",\"103\",\"WF\"]}'"
echo $cmd && eval $cmd
sleep 1s
...
localDate="$(TZ='Australia/Melbourne' date '+%FT%T.%N%:z')";
cmd="peer chaincode invoke -l golang -n anz -c '{\"Function\":\"addPaymentInstruction\", \"Args\": [\"3000\",\"ANZ\",\"WF\",\"$date\",\"BEN\",\"$vDate\",\"123457\",\"USD\",\"$localDate\",\"123\",\"103\",\"WF\"]}'"
echo $cmd && eval $cmd
sleep 1s
...
date="$(TZ=$TZ date '+%FT%T.%N%:z')";
localDate="$(TZ='Australia/Melbourne' date '+%FT%T.%N%:z')";
cmd="peer chaincode invoke -l golang -n anz -c '{\"Function\":\"addPaymentConfirmation\", \"Args\": [\"42624451a0028a178146ac5358595d38c9778a77dae6e1615a97f9c32e0d10ab\",\"$date\",\"WF\",\"$localDate\",\"1\",\"103\"]}'"
echo $cmd && eval $cmd
sleep 1s
...
date="$(TZ=$TZ date '+%FT%T.%N%:z')";
localDate="$(TZ='Australia/Melbourne' date '+%FT%T.%N%:z')";
cmd="peer chaincode invoke -l golang -n anz -c '{\"Function\":\"addPaymentConfirmation\", \"Args\": [\"$ID\",\"$date\",\"WF\",\"$localDate\",\"1\",\"103\"]}'"
echo $cmd && eval $cmd
sleep 1s
